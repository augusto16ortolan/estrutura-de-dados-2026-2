...
Repositório destinado aos códigos feitos na aula de Estrutura de Dados 2026/2.
...
```bash
git clone https://github.com/augusto16ortolan/estrutura-de-dados-2026-2.git
```

4. **Acesse a pasta do projeto:**

```bash
cd estrutura-de-dados-2026-2
```
